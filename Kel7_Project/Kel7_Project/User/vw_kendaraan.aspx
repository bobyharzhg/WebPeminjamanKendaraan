...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="618px">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db_peminjaman_mobilConnectionString %>" DeleteCommand="DELETE FROM [kendaraan] WHERE [Id] = @Id" InsertCommand="INSERT INTO [kendaraan] ([Id], [namaKendaraan], [plat], [jenis], [gambar]) VALUES (@Id, @namaKendaraan, @plat, @jenis, @gambar)" SelectCommand="SELECT * FROM [kendaraan]" UpdateCommand="UPDATE [kendaraan] SET [namaKendaraan] = @namaKendaraan, [plat] = @plat, [jenis] = @jenis, [gambar] = @gambar WHERE [Id] = @Id">
                    ...
                    <InsertParameters>
                        ...
                        <asp:Parameter Name="gambar" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="namaKendaraan" Type="String" />
                        <asp:Parameter Name="plat" Type="String" />
