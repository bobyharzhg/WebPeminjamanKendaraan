                        ...
                        <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <form id="form1" runat="server">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="tpinjam" class="form-control" TextMode="Date" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="jam_pinjam">Jam Pinjam</label>&nbsp;
                                                <asp:TextBox ID="jpinjam" class="form-control" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="tanggal_kembali">Tanggal Kembali</label>&nbsp;
                                                <asp:TextBox ID="tkembali" class="form-control" TextMode="Date" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="jam_kembali">Jam Kembali</label>&nbsp;
                                                <asp:TextBox ID="jkembali" class="form-control" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db_peminjaman_mobilConnectionString %>" DeleteCommand="DELETE FROM [peminjaman] WHERE [Id] = @Id" InsertCommand="INSERT INTO [peminjaman] ([nama_peminjam], [tanggal_pinjam], [jam_pinjam], [tanggal_kembali], [jam_kembali], [tujuan], [lokasi], [pengemudi], [penumpang], [status]) VALUES (@nama_peminjam, @tanggal_pinjam, @jam_pinjam, @tanggal_kembali, @jam_kembali, @tujuan, @lokasi, @pengemudi, @penumpang, @status)" SelectCommand="SELECT * FROM [peminjaman]" UpdateCommand="UPDATE [peminjaman] SET [nama_peminjam] = @nama_peminjam, [tanggal_pinjam] = @tanggal_pinjam, [jam_pinjam] = @jam_pinjam, [tanggal_kembali] = @tanggal_kembali, [jam_kembali] = @jam_kembali, [tujuan] = @tujuan, [lokasi] = @lokasi, [pengemudi] = @pengemudi, [penumpang] = @penumpang, [status] = @status WHERE [Id] = @Id" ProviderName="System.Data.SqlClient">
                                ...
                                <InsertParameters>
                                    ...
                                    <asp:ControlParameter ControlID="tpinjam" DbType="Date" Name="tanggal_pinjam" PropertyName="Text" />
                                    <asp:ControlParameter ControlID="jpinjam" DbType="Time" Name="jam_pinjam" PropertyName="Text" />
                                    <asp:ControlParameter ControlID="tkembali" DbType="Date" Name="tanggal_kembali" PropertyName="Text" />
                                    <asp:ControlParameter ControlID="jkembali" DbType="Time" Name="jam_kembali" PropertyName="Text" />
                                    ...
                                    <asp:ControlParameter Name="penumpang" Type="String" ControlID="penumpang" PropertyName="Text" />
                                    <asp:ControlParameter ControlID="status" DefaultValue="Diproses" Name="status" PropertyName="Text" Type="String" />
                                </InsertParameters>
                                <UpdateParameters>
                                    <asp:Parameter Name="nama_peminjam" Type="String" />
                                    <asp:Parameter DbType="Date" Name="tanggal_pinjam" />
                                    <asp:Parameter DbType="Time" Name="jam_pinjam" />
                                    <asp:Parameter DbType="Date" Name="tanggal_kembali" />
                                    <asp:Parameter DbType="Time" Name="jam_kembali" />
