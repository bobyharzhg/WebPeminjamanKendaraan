        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <table class="w-100">
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="Nama Kendaraan"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Plat"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtPlat" class="form-control" runat="server"></asp:TextBox>
                            <br />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Text="Maksimal Penumpang"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="listkapasitas" class="form-control" runat="server">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Gambar Kendaraan"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="Button1" runat="server" class="btn btn-primary" Text="Insert" Width="76px" />
                        </td>
                        <td>
                <asp:Label ID="lblMessage" runat="server" Font-Bold="True" ForeColor="#00CC66"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
